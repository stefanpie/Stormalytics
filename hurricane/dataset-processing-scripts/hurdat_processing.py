...
with open('../data/hurdat/hurdat2-1851-2018-051019.txt') as f:
...
final_df = final_df.sort_values(by=['year', 'month','day','hour','minute'])
print(final_df)

print("#### Saving processed data to file ####")
final_df.to_csv('../data/hurdat/hurdat2_processed.csv', index = False)
print("Done")
